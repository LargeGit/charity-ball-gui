...
import { Text, Stack, Box, Heading, Icon, useBreakpointValue } from "@chakra-ui/react";
...
export default function MyStory (props) {
  ...
  return (
    <Box py='6' m='4' px={[2,8]} width={useBreakpointValue({ base: "92vw", sm: '95vw', md: "90vw", lg: '850px' })}>
      ...
      <FadeInBoxLeft>
      <Stack py='6' my='4' px={[2,6]} mx={[0,4]} direction='column'>
        <Text>My name is Gemma Duff. I am 39 years old, Mum of two and my husband and I live in Charlton, Malmesbury. I am a solicitor and Partner at a regional law firm, Thrings LLP. I love spending time with my family, going on holiday and sport.</Text>
        <Text>On 19 September 2019, aged 36, I was diagnosed with secondary/incurable breast cancer.</Text>
        <Text>On that day my life as I knew it crumbled. Everything changed.</Text>
        <Text>I had breast fed both my children and shortly after having my daughter I had noticed changes to my right breast. I was referred by my GP to a breast clinic where I was given a sonogram and told I had what looked like blocked milk ducts. I was not offered a mammogram or any further testing as I had no risk factors, no family history, I was “too young” and my body probably hadn’t returned to normal after having my daughter.</Text>
        <Text>12-18 months later I had noticed further changes. Looking back I had all the telltale signs Coppafeel! tell you to look out for. Dimpling, not an obvious lump but thickening, an inverted nipple, swelling and constant pain in my armpit. I asked for another referral to get a second opinion and at that check I was immediately told it didn’t look good and was almost certainly cancer. After weeks of agonising waiting I was told that it was cancer and unfortunately it had spread to my bones which meant that I was treatable but no longer curable.</Text>
        <Text>I immediately started chemotherapy, which I completed in February 2020, and an infusion of other drugs that I have every 3 weeks for as long as they continue to work. In June 2020 I was offered a mastectomy, which I asked for, and I then had radiotherapy in August 2020.</Text>
      </Stack>
      </FadeInBoxLeft>
      ...
      <FadeInBoxRight>
      <Stack py='6' my='4' px={[2,6]} mx={[0,4]} direction='column'>
        <Text>Since embarking on this journey my life, and my perspective on life, has completely changed. I was rushing around prior to my diagnosis just trying to get through each day and each week as a busy working mum. I now live with my eyes wide open, grateful for every day and trying to ensure each day I do something that brings me joy.</Text>
        <Text>I am on treatment for life. I have recently had to change my drugs due to cancer in my bones “waking up” and starting to grow again. I am awaiting scans to see if the new drugs are working.</Text>
        <Text>I don’t feel or look sick and I can do everything that I could do before my diagnosis – essentially because even though my cancer had already spread I was still diagnosed relatively early which gives me the best possible chance. There are so many developments now that I am hopeful I will be here for many years to come.</Text>
        <Text>Initially, I did not speak about my diagnosis publicly. I am not sure why. Perhaps fear – of being labelled the sick one or being perceived as weaker somehow. Fear of being vulnerable. Perhaps putting it out there makes it feel more real and therefore more terrifying. Perhaps it is just the wish to lead a “normal” life without the sympathy or pity. </Text>
      </Stack>
      </FadeInBoxRight>
      ...
      <FadeInBoxRight>
      <Stack py='6' my='4' px={[2,6]} mx={[0,4]} direction='column'>
        <List.Root as='ol' ps='4' listStylePosition='outside'>
      ...
      <FadeInBoxRight>
      <Stack py='6' my='4' px={[2,6]} mx={[0,4]} direction='column'>
        <Text pt='2' mt='2'>Thank you</Text>
        <Text pt='2' mt='2'>Gemma</Text>
        <Heart pt='2' mt='2'/>
      </Stack>
      </FadeInBoxRight>
    </Box>
